  ...
  return (
   <>
    <div className='max-w-screen-2xl container mx-auto md:px-20 px-4'>
      <div className='items-center justify-center text-center pt-24 md:pt-32'>
        ...
        <Link to="/">
        <button className='bg-red-500 text-white px-4 py-2 rounded-md hover:bg-red-700 duration-300 mt-6 cursor-pointer'>Home</button>
        </Link>
      </div>
